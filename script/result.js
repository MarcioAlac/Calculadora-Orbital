function OrbitCalc() {
    ...
    console.log(ascentAngles)
    console.log(orbitVelocity(planet_gm, radiusPlanet_meters, planetOrbit_meters))
    console.log(escapeVelocity(planet_gm, radiusPlanet_meters, planetOrbit_meters))
    console.log(heightGravity(planet_gm, radiusPlanet_meters, planetOrbit_meters))
    console.log(heightTwr(heightGravity(planet_gm, radiusPlanet_meters, planetOrbit_meters), 4, 1000))
}
...
{
    r = RADIUS + ORBIT
    return orbitSpeed = Math.sqrt(GM / r)
}
...
{
    return gravity = GM / (Radius + Height) ** 2
}

function heightTwr(Gravity, twr, mass)
{
    return twr_out = twr * mass * Gravity
}